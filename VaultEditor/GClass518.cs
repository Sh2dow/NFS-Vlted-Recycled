...
public sealed class GClass518 : GInterface5, GInterface6
{
    [CompilerGenerated]
    private sealed class Class230
    {
        ...
        internal bool method_0(GClass495 gclass495_0)
        {
            return func_0(gclass495_0.ToString());
        }
    }

    [CompilerGenerated]
    private List<GClass495> list_0;
    ...
    [GAttribute1("Entries", DataType = GEnum20.const_5)]
    public List<GClass495> Items
    {
        [CompilerGenerated]
        get
        {
    ...
    public void imethod_5(BinaryWriter binaryWriter_0)
    {
        ...
        foreach (GClass495 item in Items)
        {
    ...
    {
        GClass518 gClass = new()
        {
            Pointer = Pointer,
            OffsetDest = OffsetDest,
            Items = []
        };
        foreach (GClass495 item2 in Items)
        {
            GClass495 item = item2.method_3();
    ...
    {
        return Items.Any(gclass495_0 => func_0(gclass495_0.ToString()));
    }
