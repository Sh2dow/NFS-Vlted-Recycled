...
public sealed class GClass158 : GClass154
{
    [CompilerGenerated]
    ...
    {
        binaryWriter_0.Write(GClass486.smethod_10(Name.String_0));
        binaryWriter_0.Write(GClass486.smethod_8(Name.String_0));
