...
internal sealed class Class259(uint uint_3, uint uint_4, int int_1, uint uint_5, string string_4, object object_1) : GClass541
{
    ...
    public override string vmethod_0()
    {
        ...
        string text3 = string_3;
        if (string.IsNullOrWhiteSpace(string_3))
        {
            text3 = "\"\"";
        }
        else if (string_3.Any(char.IsWhiteSpace))
        {
            text3 = "\"" + string_3 + "\"";
        }
        return "update_field " + String_1 + " " + String_2 + " " + String_3 + text + text2 + " " + text3;
    }
    ...
    public override GClass542 vmethod_2(VaultDatabase gclass478_0)
    {
        ...
        if (gClass5 is GClass155)
        {
            ...
            if (gClass6.Int32_0 <= int_0 || int_0 < 0)
            {
        ...
        try
        {
            TypeConverter typeConverter = Class225.smethod_0(gClass8.GEnum20_0);
            value = ((typeConverter != null) ? typeConverter.ConvertFrom(object_0) : Convert.ChangeType(object_0, gClass8.PropertyType));
            string_3 = ((typeConverter != null) ? (typeConverter.ConvertTo(object_0, typeof(string)) as string) : (Convert.ChangeType(object_0, typeof(string)) as string));
        }
        catch (Exception ex)
        {
        ...
        gClass8.SetValue(gClass7, value);
