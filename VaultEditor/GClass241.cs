...
public sealed class GClass241 : GClass154
{
    [CompilerGenerated]
    private uint uint_0;
    ...
    [GAttribute1("AudioClassKey", DataType = GEnum20.const_3)]
    public uint AudioClassKey
    {
        [CompilerGenerated]
        get
        {
    ...
    [GAttribute1("AudioCollectionKey", DataType = GEnum20.const_3)]
    public uint AudioCollectionKey
    {
        [CompilerGenerated]
        get
        {
    ...
    [GAttribute1("SFXMinSpeed")]
    public float SFXMinSpeed
    {
        [CompilerGenerated]
        get
        {
    ...
    [GAttribute1("SFXMaxSpeed")]
    public float SFXMaxSpeed
    {
        [CompilerGenerated]
        get
        {
    ...
    public override void vmethod_0(BinaryReader binaryReader_0)
    {
        ...
        binaryReader_0.ReadUInt32();
        AudioClassKey = binaryReader_0.ReadUInt32();
        AudioCollectionKey = binaryReader_0.ReadUInt32();
        binaryReader_0.ReadUInt32();
        MinSpeed = binaryReader_0.ReadSingle();
        MaxSpeed = binaryReader_0.ReadSingle();
        SFXMinSpeed = binaryReader_0.ReadSingle();
        SFXMaxSpeed = binaryReader_0.ReadSingle();
    }
    ...
    public override void vmethod_1(BinaryWriter binaryWriter_0)
    {
        ...
        binaryWriter_0.Write(0u);
        binaryWriter_0.Write(AudioClassKey);
        binaryWriter_0.Write(AudioCollectionKey);
        binaryWriter_0.Write(0u);
        binaryWriter_0.Write(MinSpeed);
        binaryWriter_0.Write(MaxSpeed);
        binaryWriter_0.Write(SFXMinSpeed);
        binaryWriter_0.Write(SFXMaxSpeed);
    }
}
