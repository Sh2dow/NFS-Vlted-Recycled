...
public sealed class GClass516 : GInterface5, GInterface6
{
    [CompilerGenerated]
    private sealed class Class228
    {
        ...
        internal bool method_0(GClass493 gclass493_0)
        {
            return func_0(gclass493_0.ToString());
        }
    }

    [CompilerGenerated]
    private List<GClass493> list_0;
    ...
    [GAttribute1("Value", DataType = GEnum20.const_5)]
    public List<GClass493> Items
    {
        [CompilerGenerated]
        get
        {
    ...
    public void imethod_5(BinaryWriter binaryWriter_0)
    {
        ...
        foreach (GClass493 item in Items)
        {
    ...
    {
        GClass516 gClass = new()
        {
            Pointer = Pointer,
            OffsetDest = OffsetDest,
            Items = []
        };
        foreach (GClass493 item2 in Items)
        {
            GClass493 item = item2.method_3();
    ...
    {
        return Items.Any(gclass493_0 => func_0(gclass493_0.ToString()));
    }
