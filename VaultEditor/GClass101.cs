...
public sealed class GClass101(int int_1, Rectangle rectangle_1) : GClass99(rectangle_1)
{
    ...
    public void method_0(Graphics graphics_0, Pen pen_0, Brush brush_0, Pen pen_1)
    {
        ...
        graphics_0.DrawLine(pen_1, rectangle_0.Left + rectangle_0.Width / 2, rectangle_0.Top + 2, rectangle_0.Left + rectangle_0.Width / 2, rectangle_0.Bottom - 2);
    }
}
